import { IntCodeComputerV2, assert, IntCodeComputer } from "../lib";
...
function partOneSolution(input: string[]) {
  ...
  const res = intCode.enqueueInput(1).execute();
  console.log(intCode.outputs)
  console.log(intCode.lastVisitedIndex)

  // console.log(input.slice(intCode.lastVisitedIndex))
...
// // TEST CASE #1
// const input1 = ["109","1","204","-1","1001","100","1","100","1008","100","16","101","1006","101","0","99"];
