...
export class Maze {
  ...
  private remainingKeys: Set<string>;
  ...
  constructor(input: string) {
    [this.maze, this.startCoords, this.remainingKeys] = this.parseMaze(input);
  }
  ...
  private parseMaze(input: string): [MazeGrid, Coord, Set<string>] {
    let startIndex = null;
